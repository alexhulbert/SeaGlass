...
AddPackage --foreign albert # A sophisticated standalone keyboard launcher
...
AddPackage --foreign alternating-layouts-git # Alternating split directions for the i3-wm
AddPackage --foreign lightly-boehs-git # A modern style for Qt applications (updated fork)
